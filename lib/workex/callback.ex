...
defmodule Workex.Callback.Stack do
  use Workex.Callback
end

defmodule Workex.Callback.Queue do
  use Workex.Callback

  def transform(messages), do: Enum.reverse(messages)
end

defmodule Workex.Callback.Unique do
  use Workex.Callback
...
defmodule Workex.Callback.EtsUnique do
  use Workex.Callback
...
defmodule Workex.Callback.Priority do
  use Workex.Callback
